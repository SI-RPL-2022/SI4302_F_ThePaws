...
Route::get('/adoptions', [WebController::class, 'indexAdoption'])->name('adoption.index');
Route::get('/adoptions/detail/{id}', [WebController::class, 'detailAdoption'])->name('adoption.detail');
