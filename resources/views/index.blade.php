    ...
    <div class="container container-title text-start">
        <div class="row align-items-center">
            <div class="col py-3">
                ...
                <a class="btn btn-primary text-white paws-blue-btn text-center explore-more-button" href="/blogs">Explore
                    More >
                </a>
            </div>
            <div class="col">
                            ...
                            <a href="/blogs" class="text-decoration-none text-black">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Dapatkan informasi terlengkap untuk hewan peliharaan
                                            kesayanganmu
                                        </p>
                                    </div>
                                </div>
                            ...
                            <a href="/pethouse" class="text-decoration-none text-black">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Dapatkan informasi mengenai klinik hewan terdekat beserta
                                            detailnya
                                        </p>
                                    </div>
                                </div>
                            ...
                            <a href="/carecommend" class="text-decoration-none text-black">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Ayo cek makanan yang cocok untuk peliharaan kesayanganmu
                                        </p>
                                    </div>
                                </div>
                            </a>
