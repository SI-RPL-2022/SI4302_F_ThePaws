    ...
    <div class="row">
        @include('admin-layouts.sidebar')
                <div class="col-9 col-sm-10 mt-5 pt-5">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ '/admin/carecommend/beratbadan/update/'.$bb->id.'' }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="">Rentang Berat Badan</label>
                                    <input type="text" class="form-control form-control-sm @error('umur') is-invalid @enderror" name="bb" value="{{ $bb->bb }}">
                                    @error('bb')
