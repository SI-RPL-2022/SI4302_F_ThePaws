    ...
    <div class="row">
            @include('admin-layouts.sidebar')
                <div class="col-9 col-sm-10 mt-5 pt-5">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/admin/category1/update/'.$data->id) }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="">Nama Kategori</label>
                                    <input type="text" class="form-control form-control-sm @error('nama') is-invalid @enderror" value="{{ $data->nama }}" name="nama" id="nama">
                                    @error('nama')
